...
namespace MSStoreWebApp.Migrations
{
    ...
    [Migration("20221004224037_step5")]
    partial class step5
    {
            ...
            modelBuilder.Entity("MSStoreWebApp.Models.Product", b =>
                {
                    ...
                    b.HasOne("MSStoreWebApp.Models.Steller", "Steller")
                        .WithMany("Products")
                        .HasForeignKey("StellerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
